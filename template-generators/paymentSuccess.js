                                        ...
                                        <tbody>
                                            ...
                                            <tr style="background: white; ">
                                                <td
                                                    ...
                                                    <p>
                                                        The transaction ${transactionId} has been successfully completed by the participant ${kriyaId}.
                                                    </p>
                                                    <table>
                                                        <tbody>
                                                            <tr >
                                                                <td style="font-weight: 600; width: 100px;">Name</td>
                                                                <td style="font-weight: 500; padding-bottom: 4px;">${name}</td>
                                                            </tr>
                                                            <tr >
                                                                <td style="font-weight: 600; width: 100px;">Email</td>
                                                                <td style="font-weight: 500; padding-bottom: 4px;">${email}</td>
                                                            </tr>
                                                            <tr >
                                                                <td style="font-weight: 600; width: 100px;">Amount</td>
                                                                <td style="font-weight: 500; padding-bottom: 4px;">Rs ${fee}.00</td>
                                                            </tr>
                                                            <tr >
                                                                <td style="font-weight: 600; width: 100px;">Type</td>
                                                                <td style="font-weight: 500; padding-bottom: 4px;">${type}</td>
                                                            </tr>
                                                            <tr >
                                                                <td style="font-weight: 600; width: 100px;">Event Id</td>
                                                            ...
                                                            <tr >
                                                                <td style="font-weight: 600; width: 100px;">Datetime</td>
                                                                <td style="font-weight: 500; padding-bottom: 4px;">${datetime}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <p>
